...
개발 문서 문서 링크
* XML :  http://developer.android.com/reference/android/view/View.html#attr_android:contentDescription
* JAVA :  http://developer.android.com/reference/android/view/View.html#setContentDescription(java.lang.CharSequence)

UI 레이아웃 XML 예제
```
<ImageView a
ndroid:id="@+id/imageView1"
...
개발 문서 문서 링크
* XML :  https://developer.android.com/reference/android/R.attr.html#labelFor
* JAVA : https://developer.android.com/reference/android/view/View.html?hl=ko#setLabelFor(int)
...
개발 문서 문서 링크
* XML :  https://developer.android.com/reference/android/widget/TextView.html?hl=ko#attr_android:hint
* JAVA :  https://developer.android.com/reference/android/widget/TextView.html?hl=ko#setHint(int)
